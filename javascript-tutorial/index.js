...
// // // // let fruit=["oranges","pineapple","strawberry"]
// // // // fruits.forEach((fruit)=> {
// // // //    let el=document.createElement("l
...
// // // artists["artistName"] = "Mary"
// // // console.log(artists)

// // // console.log(Object.keys(artists))
 

// // // Object.keys(artists).forEach(key=>console.log (key))
...
//     const 
    // fetch("http://jsonplaceholder.typicode.com/post/1").then
    ...
    // })
    async  function getData(){
     try {const  resp = await fetch("https://jsonplaceholder.typicode.com/posts/1")   
